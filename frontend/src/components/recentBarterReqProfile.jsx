...
useEffect(() => {
  ...
  const checkPendingRequest = async () => {
    if (!profile || !user) return; // wait until both are ready
    try {
...
<Card.Text>
  <strong>Skills:</strong> {profile.skills.length ? profile.skills.join(", ") : "No skills listed"}
</Card.Text>
<Card.Text>
  <strong>Desired Skills:</strong> {profile.desiredSkills.length ? profile.desiredSkills.join(", ") : "No desired skills"}
</Card.Text>

...
const AboutUs = () => {
  ...
  const founderImage =
    "https://tse3.mm.bing.net/th/id/OIP.Xi19mcDpwACn8ijRe_pGtQHaKM?pid=Api&P=0&h=180"; // Replace with an actual image link if available
        ...
        >
          ...
          <div className="d-flex flex-column align-items-center mt-4">
            ...
            <div style={{ textAlign: "center" }}>
              ...
              >
                Vijay is the visionary behind SkillBarter. With a passion for
                learning and a deep belief in the power of community, Vijay
